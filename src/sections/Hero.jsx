            ...
            <div className="w-full mx-auto">
                ...
                <div className="flex items-center justify-between px-4 md:px-12 py-6 md:py-8">
                    ...
                    <div className="flex items-center gap-4 md:gap-6">
                        ...
                        <a
                            href="/signup"
                            className="bg-[#4DA8CC]/90 text-[#F5F7FE] font-semibold text-sm rounded-2xl px-4 md:px-5 py-2.5 md:py-3 transition-colors duration-200 hover:bg-blue-500 hover:text-white focus:outline-none focus-visible:ring-2 focus-visible:ring-white/60"
                        >
                            Sign Up
                        </a>
                    </div>
                ...
                <div className="flex flex-col items-center justify-center mt-16 md:mt-32 lg:mt-44 px-4">
                    ...
                    <p className="max-w-[800px] mt-6 md:mt-8 mx-auto text-base md:text-[20px] leading-relaxed md:leading-[32px] font-medium text-center text-white/80">
